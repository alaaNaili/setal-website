...
import { Camera, Building2, ArrowRight, Puzzle } from "lucide-react";
...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-hero-subtle">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="max-w-xl animate-slide-up">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              <a
                href="/#citizens"
                className="inline-flex items-center gap-3 px-8 py-4 text-xl font-semibold rounded-xl border border-primary bg-transparent text-primary hover:bg-primary hover:text-white transition-all duration-300"
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold">
                      {t("hero.floatingCard.reported")}
                    </p>
                    <p className="text-xs text-muted-foreground">
                      {t("hero.floatingCard.justNow")}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute bottom-6 right-6 animate-float-delay rounded-xl bg-background/95 p-4 shadow-soft backdrop-blur-sm">
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-setal-green/20">
                    <svg
                      className="h-5 w-5 text-setal-green"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <div>
                    <p className="text-sm font-semibold text-setal-green">
                      {t("hero.floatingCard.resolved")}
                    </p>
                    <p className="text-xs text-muted-foreground">
                      {t("hero.floatingCard.hoursAgo")}
                    </p>
                  </div>
                </div>
              </div>
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-[45%] -translate-x-1/2 animate-bounce">
